...
export default function Login() {
  return (
    <div className="h-screen flex-center bg-background">
      <div
        className="flex grid grid-cols-1 md:grid-cols-2 rounded-[30px] m-4 shadow-xl w-full md:max-w-[900px] h-[400px] bg-white">
        <div className="hidden md:block bg-primary p-8 rounded-l-[30px] rounded-r-[100px]">
          <div className="h-full flex flex-col justify-center">
            ...
            <CommonButton href="/register">Sign Up</CommonButton>
          </div>
        </div>
